var Debug = {
	...
	loadTime : function() {
		if (window.performance && window.performance.timing) {
			...
			console.log(this.DEBUG_PREFIX+"User-perceived page loading time: " + page_load_time+" ms");
	...
	stop:function(id)
	{
		...
		console.log(this.DEBUG_PREFIX+"Timer - "+id+" took "+(this.timers[id].end-this.timers[id].start)+" ms");
