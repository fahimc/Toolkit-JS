...
Class.extend(PaddedLayout, Layout);var GridLayout = function() {
	this.arrange = function(e) {
...
Class.extend(GridLayout, Layout);var ScrollLayout = function() {
...
_.startX
_.startY
_.maxHeight = 0;var DisplayObject = function() {
	/*
	 * local variables
	 */
	this.display = null;
...
Class.implement(ArrayIterator,IIterator);var Collection = function(arr) {
...
Class.implement(Model, IModel);var Engine = function() {
	this.event = {
		READY : "ENGINE_READY"
	};
	 this.prop = {
	...
	//
	this.removeFromBackgroundLayer = function(obj) {
		var l = document.getElementById(this.prop.layer.bgId);
		if (obj.display) {
			l.removeChild(obj.display);
		} else {
			l.removeChild(obj);
		}
	};
	this.removeFromCharacterLayer = function(obj) {
		var l = document.getElementById(this.prop.layer.character);
		if (obj.display) {
			l.removeChild(obj.display);
		} else {
	...
	this.removeFromFrontLayer = function(obj) {
		var l = document.getElementById(this.prop.layer.front);
		if (obj.display) {
			l.removeChild(obj.display);
		} else {
