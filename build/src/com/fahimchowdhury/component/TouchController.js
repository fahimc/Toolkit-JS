...
(function() {
	...
	_.onDpadMouseDown = function(event) {
		...
		if ('ontouchstart' in window) {
			this.dpad.display.addEventListener("touchend", this.createHandler(this, "onDpadMouseUp"));
	...
	_.onDpadMouseUp = function(event) {
		if ('ontouchstart' in window) {
			this.dpad.display.removeEventListener("touchend", this.createHandler(this, "onDpadMouseUp"));
